...
import { FileText, Download, ArrowRight, Shield, Zap, FileCheck, Loader2, AlertCircle } from 'lucide-react';
...
export default function PdfToWordInterface() {
  ...
  const processFile = async () => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.pdfToWord, {
        method: 'POST',
        body: formData,
      });
    ...
    <div className="space-y-8">
      {!file && !isComplete && (
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-8 max-w-xs mx-auto">
            Drag and drop your PDF here or click to browse. Your file will be converted using our server-side engine.
          </p>
      ...
      {isComplete && (
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-8">Your DOCX file has been downloaded.</p>
