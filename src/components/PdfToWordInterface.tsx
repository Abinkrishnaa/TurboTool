    ...
    <div className="space-y-8">
      ...
      {isComplete && (
        <motion.div
          ...
          className="text-center p-8 sm:p-12 bg-white dark:bg-slate-900 rounded-3xl border-2 border-slate-900 dark:border-white shadow-[0_20px_50px_rgba(0,0,0,0.1)]"
        >
